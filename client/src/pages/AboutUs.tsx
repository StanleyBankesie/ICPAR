    ...
    <div>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-30 mt-18">
            <div>
              <div className="  bg-primary-100 rounded-full flex items-center justify-center mb-8 shadow-md py-8 px-2 mx-5">
            ...
            <div>
              <div className=" bg-primary-100 rounded-full flex items-center justify-center mb-8 shadow-md py-8 mx-5">
                <span className="text-3xl text-primary-700">
